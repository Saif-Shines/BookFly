...
2. Create an emulator if you haven’t already done so. The emulator needs to be on minimum API 8: Froyo. Any screen/phone size will do. Any higher API will also work. 
